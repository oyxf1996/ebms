...
<%'容错处理
function Recruit_list_to_html(ClassID)
...
<%
 '文章列表读取替换
sql="select * from [web_info] where "&ClassSQL&"='"&ClassID&"' and view_yes=1  order by [time] desc"
set rs1=server.createObject("ADODB.Recordset")
rs1.open sql,cn,1,1
%><%
if not rs1.eof then
...
list_block=list_block&"<tr><td width='14%' align='center' bgcolor='#F9F9F9'>工作地点：</td>"
list_block=list_block&"<td width='86%' align='left' bgcolor='#FFFFFF'><strong>&nbsp;"&rs("address")&"</strong></td></tr>"
list_block=list_block&"<tr><td width='14%' align='center' bgcolor='#F9F9F9'>工资待遇：</td>"
list_block=list_block&"<td width='86%' align='left' bgcolor='#FFFFFF'><strong>&nbsp;"&rs("person")&"</strong></td></tr>"
list_block=list_block&"<tr><td width='14%' align='center' bgcolor='#F9F9F9'>招聘人数：</td>"
list_block=list_block&"<td width='86%' align='left' bgcolor='#FFFFFF'><strong>&nbsp;"&rs("tel")&"</strong></td></tr>"
list_block=list_block&"<tr><td width='14%' align='center' bgcolor='#F9F9F9'>性别要求：</td>"
list_block=list_block&"<td width='86%' align='left' bgcolor='#FFFFFF'><strong>&nbsp;"&rs("email")&"</strong></td></tr>"
list_block=list_block&"<tr><td width='14%' align='center' bgcolor='#F9F9F9'>年龄要求：</td>"
list_block=list_block&"<td width='86%' align='left' bgcolor='#FFFFFF'><strong>&nbsp;"&rs("qq")&"</strong></td></tr>"
list_block=list_block&"<tr><td width='14%' align='center' bgcolor='#F9F9F9'>条件要求：</td>"
list_block=list_block&"<td width='86%' align='left' bgcolor='#FFFFFF'><strong>&nbsp;"&rs("description")&"</strong></td></tr>"
list_block=list_block&"<tr><td align='center' bgcolor='#F9F9F9'>职位描述：</td>"
